...
class plgHikashoppaymentPlatron extends hikashopPaymentPlugin
{
	...
	var $pluginConfig = array(
		...
		'success_url' => array('SUCCESS_URL', 'input'),
		'failure_url' => array('FAILURE_URL', 'input'),
	...
	function onAfterOrderConfirm(&$order,&$methods,$method_id) {
		...
		$arrFields = array(
			...
			'pg_currency'			=> $this->currency->currency_code,
			...
			'pg_success_url'		=> @$this->payment_params->success_url,
			'pg_failure_url'		=> @$this->payment_params->failure_url,
			'pg_request_method'		=> 'GET',
			'cms_payment_module'	=> 'HIKASHOP',
	...
	function onPaymentNotification(&$statuses){
		...
		unset($arrRequest['hikashop_payment_notification_plugin']);
